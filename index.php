...
<head>
    ...
    <title>Tabla pedido Coca Cola</title>
...
<body class="bg-light">
    ...
    top: 0 !important; z-index : 99999 !important;">
        <div class="container-fluid container">
            <a class="navbar-brand" href="#">Cocacola |  Miguel Jared Renteria Marrufo</a>
    ...
    <div class="container mt-5">
        ...
        <div class="card mb-5">
            <!-- agregar datos -->
            <div class="card-body">
                <h3 class="card-title">Mi negocio Coca Cola </h3>
                <h4 class="card-text">Tabla pedido</h4>
                <p class="card-text">Elaborado por: Miguel Jared Renteria Marrufo</p>
                ...
                <form class="row g-3" action="agregar.php" method="POST">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="id_producto" class=" form-control" placeholder="00000" required>
                    </div>
                    <div class="col-md-12">
                        <label for="id_cliente" class="form-label"> id_cliente</label>
                        <input type="text" name="id_cliente" class=" form-control" placeholder="00000" required>
                    </div>

                    <div class="col-md-4">
                        <label for="cantidad" class="form-label">cantidad</label>
                        <input type="text" name="cantidad" class="form-control" placeholder="0000" required>
                    </div>

                    <div class="col-md-4">
                        <label for="precio_unitario" class="form-label">precio unitario</label>
                        <input type="text" name="precio_unitario" class="form-control" placeholder="00000" required>
                    </div>

                    <div class="col-md-6">
                        <label for="subtotal" class="form-label">subtotal</label>
                        <input type="text" name="subtotal" class="form-control" placeholder="00000" required>
                    </div>

                    <div class="col-md-6">
                        <label for="descuento" class="form-label">descuento</label>
                        <input type="text" name="descuento" class="form-control" placeholder="00000" required>
                    </div>
                    <div class="col-md-6">
                        <label for="impuesto" class="form-label">impuesto</label>
                        <input type="text" name="impuesto" class="form-control" placeholder="00000" required>
                    </div>
        ...
        <div class="table-responsive mb-5 card">
            ...
            $datos = mysqli_query($db, "SELECT * FROM pedido");
            $cantidad_datos = mysqli_num_rows($datos);
            $total_pagina = ceil($cantidad_datos / $limite);

            $datos_pedido = mysqli_query($db, "SELECT * FROM pedido LIMIT $pagina_principal, $limite");
            $Id_pedido = $pagina_principal + 1;
            ...
            while ($pedido = mysqli_fetch_array($datos_pedido)) {
                echo "<tr>";
                echo "<td style='display:none'>" . $pedido['id_pedido'] . "</td>";
                echo "<td class='text-center'>" . $Id_pedido++ . "</td>";
            ...
            <div class='modal-dialog' style="margin-bottom:100px !important;">
                <div class='modal-content'>
                    <div class='modal-header'>
                        <h5 class='modal-title' id='exampleModalLabel'>Editar Datos de pedido</h5>
                    ...
                    <form action='editar.php' method='POST'>
                        <div class='modal-body text-start'>
                            <input type='hidden' name='editar_Id_pedido' id='editar_Id_pedido'>

                    <div class="col-12">
                        <label for="editar_id_producto" class="form-label"> id producto</label>
                        <input type="text" name="editar_id_producto" id="editar_id_producto" class="form-control" placeholder="0010" required>
                    </div>
                    <div class="col-md-4">
                        <label for="editar_id_cliente" class="form-label">id_cliente</label>
                        <input type="text" name="editar_id_cliente" id="editar_id_cliente" class="form-control" placeholder="0010" required>
                    </div>

                    <div class="col-md-4">
                        <label for="editar_cantidad" class="form-label">cantidad</label>
                        <input type="text" name="editar_cantidad" id="editar_cantidad" class="form-control" placeholder="20" required>
                    </div>

                    <div class="col-md-4">
                        <label for="editar_precio_unidad" class="form-label">precio unitario</label>
                        <input type="text" name="editar_precio_unidad" id="editar_precio_unidad" class="form-control" placeholder="17.5" required>
                    </div>

                    <div class="col-md-6">
                        <label for="editar_subtotal" class="form-label">subtotal</label>
                        <input type="text" name="editar_subtotal" id="editar_subtotal" class="form-control" placeholder="6565265147" required>
                    </div>

                    <div class="col-md-6">
                        <label for="editar_descuento" class="form-label">descuento</label>
                        <input type="text" name="editar_descuento" id="editar_descuento" class="form-control" placeholder="hola@gmail.com" required>
                    </div>
                    <div class="col-md-6">
                        <label for="editar_impuesto" class="form-label">impuesto</label>
                        <input type="text" name="editar_impuesto" id="editar_impuesto" class="form-control" placeholder="hola@gmail.com" required>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            $('.btnEditar').on('click', function() {
                ...
                console.log(data);
                $('#editar_Id_pedido').val(data[0]);
                // gak dipake, karena cuma increment number
                // $('#no').val(data[1]);
                $('#editar_id_producto').val(data[2]);
                $('#editar_id_cliente').val(data[3]);
                $('#editar_cantidad').val(data[4]);
                $('#editar_precio_unidad').val(data[5]);
                $('#editar_subtotal').val(data[6]);
                $('#editar_descuento').val(data[7]);
                $('#editar_impuesto').val(data[8]);
            });
        });
    </script>
